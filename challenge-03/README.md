...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Marcus Fernandes!'
...
*/
pessoa.caminhouQuantosMetros //123
...
// Agora, apresente-se ;)
pessoa.apresentacao() //Olá, eu sou o Marcus Fernandes, tenho 32 anos, 1.8, meu peso é 100 e, só hoje, eu já caminhei 123 metros!
```
